...
all: dist/index.html dist/munkanaplo.html dist/h1/projektterv.html dist/h2/vizio-v0.9.html dist/h2/index.html dist/h2/vizio-v0.9.html dist/h2/vizio-v1.0.html

h1_md_files := $(wildcard h1/*.md)
h2_vizio_v0.9_md_files := $(wildcard h2/v0.9/*.md)
